...
public class UserInEvent extends Event {
    ...
    // Get a list of 'Request for Ride Events' from me
    public List<UserInEvent> getMyRequestedRides(String eventOwnerLoginId)
    {
        List<UserInEvent> requestedRides = new ArrayList<UserInEvent>();
        UserInEvent participant = null;

        String url_read_event = "http://www.hovhelper.com/read_my_requested_users_in_event.php";
        ...
        //ToDo remove deprecated approach and use URLBuilder instead
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("loginId", eventOwnerLoginId));
