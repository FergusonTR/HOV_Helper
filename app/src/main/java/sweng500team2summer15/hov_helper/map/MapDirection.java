...
public class MapDirection {
    ...
    public static class GetDirectionAsyncTask extends AsyncTask<Map<String, String>, Object, ArrayList>
    {
        ...
        {
            Toast.makeText(activity, activity.getString(R.string.common_google_play_services_error_notification_requested_by_msg/*.error_when_retrieving_data*/), Toast.LENGTH_LONG/*3000*/).show();
        }
    }
